...
public:
    ...
    /**@brief takes the string from the config file and creates a BaBitvector
     * of the rv node configuration
     */
    int initializeFIDConfig(String rvNode, BABitvector &node); 
    ...
    String masterID, parentID, leftID, rightID;
    BABitvector masterRVFID;
    BABitvector parentRVFID;
    BABitvector leftRVFID;
    BABitvector rightRVFID;
