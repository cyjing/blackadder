...
public:
    ...
    /** handles packet when it is a rv update from another rv
     *  reads the packet
     *
    **/
  unsigned int handle_RV_updates(Packet * p);
     ...
     */
    unsigned int publish_scope(RemoteHost *_publisher, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int publish_root_scope(RemoteHost *_publisher, String &ID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int publish_inner_scope(RemoteHost *_publisher, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int republish_inner_scope(RemoteHost *_publisher, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int publish_info(RemoteHost *_publisher, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int advertise_info(RemoteHost *_publisher, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int readvertise_info(RemoteHost *_publisher, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int unpublish_scope(RemoteHost *_publisher, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int unpublish_info(RemoteHost *_publisher, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int subscribe_scope(RemoteHost *_subscriber, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int subscribe_root_scope(RemoteHost *_subscriber, String &ID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int subscribe_inner_scope(RemoteHost *_subscriber, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int subscribe_info(RemoteHost *_subscriber, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
  unsigned int unsubscribe_scope(RemoteHost *_subscriber, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
     ...
     * @return one of the return codes (see helper.hh).
     */
    unsigned int unsubscribe_info(RemoteHost *_subscriber, String &ID, String &prefixID, unsigned char &strategy, bool RV_update);
    ...
    void UpdateMasterRVNode(unsigned char IDLengthOfAPIEvent, String &IDOfAPIEvent, unsigned char type, unsigned char IDLength, String &ID, unsigned char prefixIDLength, String &  prefixID, unsigned char strategy, String &ts);
  
    void UpdateChildRVNodes(unsigned char IDLengthOfAPIEvent, String &IDOfAPIEvent, unsigned char type, unsigned char IDLength, String &ID, unsigned char prefixIDLength, String &prefixID, unsigned char strategy, String &ts);
    ...
    BABitvector masterRV_dl;
    BABitvector parentRV_dl;
    BABitvector leftRV_dl;
    BABitvector rightRV_dl;
    bool hasLeft;
    bool hasRight;
    ...
    RVUpdates updateIndex;

   /**
    * map of node strings to a vector of the scopes they are subscribed to
   **/
    map<String, Vector<String> > sub_list;
};
