...
#define RV_UPDATE 9 //when the rv wants to update other rvs
#define NODE_DISCONNECT 10// when a node disconnects from the topology
#define CONNECT 12
...
#define NEWCONNECTIONS_NODE 107	
#define NEWCONNECTIONS_STAR 108	
#define RV_RECONFIGURE_NODE 109	
#define RV_RECONFIGURE_RV 110	
...
/*RV talking to each other
 */
#define RV_PUBLISH_SCOPE 20
#define RV_PUBLISH_INFO 21
#define RV_UNPUBLISH_SCOPE 22
#define RV_UNPUBLISH_INFO 23
#define RV_SUBSCRIBE_SCOPE 24
#define RV_SUBSCRIBE_INFO 25
#define RV_UNSUBSCRIBE_SCOPE 26
#define RV_UNSUBSCRIBE_INFO 27
/**********************************/
