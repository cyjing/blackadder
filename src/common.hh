...
/** @brief A Click's HashTable of the time of an update and mapped to a id */
typedef map<String, String> RVNodeInfo;
/** @brief A Click's HashTable of a node and mapped to a RVNodeInfo*/
typedef HashTable<String, RVNodeInfo*> RVUpdates;


/** @brief A pair of the time Stamp and whether there was any return Ping */
typedef pair<double, bool> PingInfo;
/** @brief A Click's HashTable of a node and mapped to a the Ping info*/
typedef HashTable<String, PingInfo*> PingUpdates;
