...
public:
	...
	/**@brief calculates and assigns the default LIPSIN identifier from each node to the other RVs.
     */
    void calculateRVNodesFIDs(RV_leaf* rvNode);

    void calculateRVNodesRecursive();
     ...
     */
    map <string, int> reverse_RVnode_index;
	
	map<string, vector<string> *> RV_nodeList;
