...
public:
    ...
    /**@brief a vector of all RV nodes
    */
    vector<NetworkNode *> RV_nodes;

    vector<NetworkConnection *> RV_connections;
 
    /**@brief the rv tree
    */
    RV_leaf *master;
    /**@brief the Master RV node
    */
    NetworkNode *Master_RV_node;
	...
	/**@brief Finds closest RV node for NetworkNode
	* 	
	*/
	string getRVNodeLabel();
};
...
public:
  ...
  RV_leaf(NetworkNode* master, NetworkNode* parent, NetworkNode* self);

  void add(NetworkNode* newRV, vector<NetworkConnection *> &RV_connections); 
  int getNodes();
...
public:
	...
	string RVlabel;//will be calculated
    Bitvector FID_to_Master_RV; //will be calculated
    Bitvector FID_to_Parent_RV; //will be calculated
    Bitvector FID_to_Left_RV; //will be calculated
    Bitvector FID_to_Right_RV; //will be calculated
